    ...
    if (mobile) {
        return (
            <div className={classes.mobileWrapper}>
                <IconBtn icon={GitHub} m={1} href="https://github.com/ndivhuho22" />
                <IconBtn icon={Instagram} m={1} href="https://www.instagram.com/ndivhuho22/" />
                <IconBtn icon={LinkedIn} m={1} href="https://www.linkedin.com/in/ndivhuho-nthompe-mphelo-4a467b192/" />
                <IconBtn icon={Email} m={1} href="mailto:mphelonn@gmail.com" />
            </div>
        );
    } else {
        return (
